...
const CACHE_NAME = "melting-pro-2.1-v1";
const URLS = [".","index.html","style.css","app.js","manifest.json","icons/icon-A-192.png","icons/icon-A-512.png","icons/icon-gear-192.png","icons/icon-gear-512.png"];
